...
**Note:** cloned from [aws official repo for developers](https://github.com/awsdocs/aws-lambda-developer-guide)
...
![Service Map](images/java-basic-servicemap.png)

Choose a node in the main function graph. Then choose **View traces** to see a list of traces. Choose any trace to view a timeline that breaks down the work done by the function.

![Trace](images/java-basic-trace.png)
